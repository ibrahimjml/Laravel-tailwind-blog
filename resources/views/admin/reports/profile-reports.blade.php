...
@include('admin.partials.header', ['linktext' => 'Profile Reports', 'route' => 'admin.posts', 'value' => request('search')])
...
<div class="rounded-xl overflow-hidden bg-white shadow">
  ...
  <table class="min-w-full table-auto ">
    ...
    <tr class="bg-gray-600">
      ...
      <th class="text-white p-2">Profile</th>
      <th class="text-white p-2">Profile Author</th>
    ...
    @forelse ($reports as $report)
      ...
      @can('profilereport.delete')
       ...
       <a href="{{route('profile',$report->profile->username)}}"><i class="fas fa-eye "></i></a>
        ...
        @include('admin.partials.action-report-status-menu',['type'=>'profile','report'=>$report])
        </div>
        @endcan
      </div>
      </td>
