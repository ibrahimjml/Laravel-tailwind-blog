...
@include('admin.partials.header', ['linktext' => 'Comment Reports', 'route' => 'admin.posts', 'value' => request('search')])
...
<div class="rounded-xl overflow-hidden bg-white shadow">
  ...
  <table class="min-w-full table-auto ">
    ...
    <tr class="bg-gray-600">
      ...
      <th class="text-white p-2">Comment Post</th>
      <th class="text-white p-2">Comment Content</th>
      <th class="text-white p-2">Comment Author</th>
    ...
    @forelse ($reports as $report)
      ...
      @can('commentreport.delete')
       ...
       <a href=""><i class="fas fa-eye "></i></a>
        ...
        @include('admin.partials.action-report-status-menu',['type'=>'comment','report'=>$report])
        </div>
        @endcan
      </div>
      </td>
