  ...
  <div class=" md:ml-64  px-4 py-2 mb-3 -m-24 w-[80%]">
    ...
    <div class="flex gap-2 items-center">
      ...
      <form action="{{ url()->current() }}" method="GET" class="flex items-center gap-1">
        ...
        onchange="this.form.submit()" class="rounded-full w-4 h-4">
        <label class="text-white font-semibold" for="reported">Reported</label>
      </form>
      </div>
    </div>
...
<div class="relative md:ml-60 rounded-xl bg-white shadow w-[86%] left-6 overflow-hidden">
  <div class="w-full overflow-x-auto">
    <table class="min-w-max table-auto w-full">
      ...
      <tr class="bg-gray-600">
        ...
        <th class="text-white p-2">Categories</th>
        <th class="text-white p-2">Reported</th>
        <th class="text-white p-2">Reports Count</th>
