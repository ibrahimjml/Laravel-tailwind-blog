...
Username:
 ...
 <input  type="text" class="block  w-72 rounded-lg p-2 border-2 text-white  bg-transparent @error('username') border-red-500 @enderror"
  name="username" >
  @error('username')
      <p class="text-red-500 text-xs italic mt-4">
          {{ $message }}
...
Email:
 ...
 <input  type="text" class="block  w-72 rounded-lg p-2 border-2 text-white  bg-transparent @error('email') border-red-500 @enderror"
  name="email" >
  @error('email')
      <p class="text-red-500 text-xs italic mt-4">
          {{ $message }}
...
<input  type="number" class="block  w-72 rounded-lg p-2 border-2 text-white  bg-transparent @error('age') border-red-500 @enderror"
name="age" >
@error('age')
<p class="text-red-500 text-xs italic mt-4">
  {{ $message }}
