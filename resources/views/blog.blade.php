...
<div class="flex flex-col">
  <span class="text-lg ">
    <a href='/profile/{{$post->user->username}}' class="hover:underline font-bold">{{$post->user->username}}</a>
  </span>
  ...
  <div class="max-h-[460px] break-words" >
    <h1 class="text-xl md:text-2xl font-bold text-gray-700 mt-6 md:mt-14 ">{{$post->title}}</h1>
