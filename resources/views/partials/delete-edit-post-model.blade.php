...
<button id="openmodel" class="absolute top-3 right-3 z-10 rounded-[50%] bg-slate-100 hover:bg-opacity-65 transition-bg-opacity duration-100">
  <img src="/threeDotMenu.png" width="26px" alt="">
</button>
{{-- delete|edit model  --}}
